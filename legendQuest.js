...
function game() {
    ...
    var greeting = function(name) {
        ...
        var nameConfirm = function(answer) {
            if (answer === "Y") {
        ...
        nameConfirm(prompt("Are you sure? (Y/N)"));
    ...
    var user = {
        name: "Adventurer",
        health: Math.max(25, 25),
        shipHealth: 20,
        potions: 1,
        gold: 100,
        swordDamage: 1,
        canteen: Math.max(8, 8),
        warmth: 10,
        poisoned: false
    };
    ...
    var display = {
        name: user.name,
        health: user.health,
        shipHealth: user.shipHealth,
        potions: user.potions,
        gold: user.gold,
        swordDamage: user.swordDamage,
    ...
    function ApplyDamage(Damage) {
        user.health -= Damage;
        document.getElementById("health").innerHTML = user.health + "/25" + " (-" + Damage + ")";
        if (user.health <= 0) { //Dead Player
            sleep(1000);
            document.getElementById("text").innerHTML = "Your adventure ends here...";
            sleep(1000);
    ...
    function ApplyShipDamage(Damage) {
        user.shipHealth -= Damage;
        document.getElementById("shiphealth").innerHTML = user.shipHealth + "/20" + " (-" + Damage + ")";
        if (user.shipHealth <= 0) { //Dead Player
            sleep(1000);
            document.getElementById("text").innerHTML = "Your adventure ends here...";
            sleep(1000);
            gameRestart(prompt("Restart? (Y/N)"));
    ...
    function ApplyHealing() {
        if (potions > 0) {
            ...
            user.potions -= 1;
            console.log(user.name + "'s Health: " + user.health + "/25 (+5)");
            console.log(user.name + "'s Potions: " + user.potions + " (-1)");
            sleep(1000);
        }
        else {
    ...
    function maxHeal() {
        ...
        console.log(user.name + "'s Health: " + user.health + "/25");
        sleep(1000);
    }

    var userHeal = function(answer) {
        console.log( user.name + "'s Current Health: " + user.health + "/25");
        if (answer === "Y"){
            ApplyHealing(1);
        }
        else {
    ...
    function findPotion(number) {
        user.potions += number;
        console.log(user.name + "'s potions: " + user.potions + " (+" + number + ")");
        sleep(1000);
    }
    ...
    function findMoney(number) {
        user.gold += number;
        console.log(user.name + "'s Gold: " + user.gold + " (+" + number + ")");
        sleep(1000);
    }
    ...
    function newSwordDamage(number) {
        user.swordDamage = number;
        console.log(user.name + " equips a better sword!");
        sleep(1000);
    }
    ...
    function poisonDamage() {
        if (user.poisoned = true) {
            user.health -= 1;
            console.log(user.name + "'s Health: " + user.health + "/25" + " (- 1 from Poison)");
            if (user.health <= 0) { //Dead Player
                sleep(1000);
    ...
    function findWater() {
        ...
        if (user.canteen > 8) {
            ...
            user.console.log("You refill your canteen!");
            sleep(1000);
        }
        user.console.log(user.name + "'s Canteen: " + user.canteen + "/8");
        sleep(1000);
    }
    ...
    function loseWater(number) {
        ...
        console.log(user.name + "'s Canteen: " + user.canteen + "/8 (-" + number + ")");
        sleep(1000);
    }
    ...
    function gainWarmth() {
        ...
        console.log(user.name + "'s Warmth: " + user.warmth + "/10");
        sleep(1000);
    }
    ...
    function loseWarmth(number) {
        ...
        console.log(user.name + "'s Warmth: " + user.warmth + "/10 (-" + number + ")");
        sleep(1000);
    }
    ...
    var directions = function(direction) {
        ...
        if (direction === "N") {
            ...
            if (Math.random() < 0.34) {
                ...
                sleep(1000);
                loseWarmth(1);
                while (user.warmth > 2 || user.warmth > 9) {
                    sleep(4000);
        ...
        //SOUTHWARD
            ...
            if (Math.random() < 0.34) {
                ...
                sleep(1000);
                while (user.canteen > 0 || user.canteen > 7) {
                    sleep(4000);
                    console.log("You have to decide which direction to go.");
                    sleep(5000);
